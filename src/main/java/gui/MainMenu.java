...
public class MainMenu {
	...
	public void draw(Graphics2D g) {
      ...
      Graphics2D gTemp = g;
			...
			_cbs.add(new ControlButton("Casa Blanca", 3*_w/2, _h/5 + 4*c, g));
			_cbs.add(new ControlButton("Torre Eiffel", 3*_w/2, _h/5 + 5*c, g));
			_cbs.add(new ControlButton("San Francisco", 3*_w/2, _h/5 + 6*c, g));
			_cbs.add(new ControlButton("Tepic MIC", 3*_w/2, _h/5 + 7*c, g));
			_cbs.add(new ControlButton("Londres", 3*_w/2, _h/5 + 8*c, g));
